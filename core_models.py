...
class TeacherRequest(Base):
    """O'qituvchi bo'lish uchun to'lov so'rovi. Foydalanuvchi 'To'lov qildim' tugmasini
    bosganda 'pending' holatda yaratiladi, admin panel orqali tasdiqlanadi yoki rad etiladi."""
