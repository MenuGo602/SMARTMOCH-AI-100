      ...
      <div className="sm-anim" style={{ maxWidth: 420, width: "100%" }}>
        ...
        {pending ? (
          ...
          <Card style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${C.v1}55`, padding: 24 }}>
            ...
            <p style={{ color: "#D8D2F2", fontSize: 13, textAlign: "center", marginBottom: 22, lineHeight: 1.5 }}>
              Imtihon yaratish, AI generatsiya va talabalarni boshqarish imkoniyatlari uchun bir martalik to'lov talab qilinadi.
            </p>
            ...
            <div style={{ background: "rgba(255,255,255,0.08)", borderRadius: 14, padding: 18, marginBottom: 18 }}>
              ...
              <div className="sm-mono" style={{ fontSize: 26, fontWeight: 700, color: "#fff", marginBottom: 16 }}>{PRICE} so'm</div>
            ...
            <p style={{ color: "#D8D2F2", fontSize: 12, lineHeight: 1.6, marginBottom: 20 }}>
              Yuqoridagi kartaga {PRICE} so'm o'tkazib, pastdagi tugmani bosing. To'lovingiz admin tomonidan tekshirilgach, o'qituvchi paneliga kirish imkoniyati ochiladi.
            </p>
...
const TELC_LEVELS = {
  A1: {
    ...
    hören: { label: "Hören", teils: [
      { name: "Teil 1 — Rasmlar va dialoglar", type: "mcq", playCount: 2 },
      { name: "Teil 2 — Richtig/Falsch", type: "truefalse", playCount: 1 },
      { name: "Teil 3 — Multiple Choice", type: "mcq", playCount: 2 },
    ]},
  ...
  A2: {
    ...
    sprachbausteine: null,
    hören: { label: "Hören", teils: [
      { name: "Teil 1 — Dialoglar", type: "mcq", playCount: 2 },
      { name: "Teil 2 — Richtig/Falsch", type: "truefalse", playCount: 1 },
      { name: "Teil 3 — Multiple Choice", type: "mcq", playCount: 2 },
    ]},
  ...
  B1: {
    ...
    hören: { label: "Hören", teils: [
      ...
      { name: "Teil 2 — Multiple Choice", type: "mcq", playCount: 2 },
      { name: "Teil 3 — Zuordnen (moslashtirish)", type: "mcq", playCount: 2 },
    ]},
  ...
  B2: {
    ...
    hören: { label: "Hören", teils: [
      { name: "Teil 1 — Dialoglar", type: "mcq", playCount: 2 },
      { name: "Teil 2 — Intervyu yoki reportaj", type: "mcq", playCount: 1 },
  ...
  C1: {
    ...
    hören: { label: "Hören", teils: [
      ...
      { name: "Teil 2 — Interview (intervyu)", type: "mcq", playCount: 1 },
      { name: "Teil 3 — Diskussion (munozara)", type: "mcq", playCount: 1 },
    ]},
